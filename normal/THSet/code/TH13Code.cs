    ...
    public class TH13Code:THCode {
        ...
        public override void SetStage(MaterialListView stage,MaterialListView chapter,MaterialListView mBoss,MaterialListView boss) {
            ...
            switch(getText(stage)) {
                case "Stage1": boss.AddRange(EclHelper.TH13.stage1BossList); break;
                case "Stage2": boss.AddRange(EclHelper.TH13.stage2BossList); break;
                case "Stage3": boss.AddRange(EclHelper.TH13.stage3BossList); break;
                case "Stage4": boss.AddRange(EclHelper.TH13.stage4BossList); chapter.Items.Clear(); chapter.AddRange(new string[] { "前半","道中Boss","太田飞行阵","关底Boss" }); break;
                case "Stage5": boss.AddRange(EclHelper.TH13.stage5BossList); break;
                case "Stage6": boss.AddRange(EclHelper.TH13.stage6BossList); chapter.Items.Clear(); chapter.AddRange(new string[] { "前半","关底Boss" }); break;
                case "Extra": boss.AddRange(EclHelper.TH13.stage7BossList); break;
            }
        }
        public override void SetChapter(MaterialListView stage,MaterialListView chapter,MaterialListView mBoss,MaterialListView boss) {
            ...
            byte[] eclMainLatter = getText(stage).Equals("Extra") ? EclHelper.TH13.eclExtraMainLatter : EclHelper.stageEcl[2];
