...
namespace THSet {
    class TH13Code:THCode {
        ...
        public override void setMemoryTool(MemoryTool m) {
            ...
            write(0x00444A52,new byte[] { 0xE9,0xEA,0xFC,0xFF,0xFF,0x90 });
            write(0x00444741,new byte[] { 0xFF,0x0D,0xF4,0xE7,0x4B,0x00,0xE9,0xA7,0xFD,0xFF,0xFF });
            write(0x004444F3,new byte[] { 0xFF,0x05,0x80,0xEC,0x4B,0x00,0xE9,0x5A,0x05,0x00,0x00 });
            write(0x004BEC80,0);


            write(0x0040A404,new byte[] { 0xEB,0x7B,0x90,0x90,0x90 });
            write(0x0040A481,new byte[] { 0xA3,0x00,0xE8,0x4B,0x00,0xFF,0x05,0x84,0xEC,0x4B,0x00,0xEB,0x35 });
            write(0x0040A4C3,new byte[] { 0xE9,0x41,0xFF,0xFF,0xFF });
            write(0x004BEC84,0);
        ...
        public override void setFPS(int i) {
            if(write(0x60016A8C,i)==0) {
                ...
                write(0x0045D368,new byte[] { 0xDD,0x05,0x87,0xCE,0x45,0x00 });
            }
        }
