...
namespace THSet {
    class TH12Code:THCode {
        ...
        public override void setMemoryTool(MemoryTool m) {
            ...
            write(0x00422CD1,new byte[] { 0xA3,0xA0,0x0C,0x4B,0x00,     //sub [004B0C98],ebx
                                          0xFF,0x05,0xA4,0x10,0x4B,0x00,//inc [004B10A0]
        ...
        public override void setLockBomb(bool b) {
            write(0x00422F28,b ? new byte[] { 0x90,0x90,0x90,0x90,0x90 } ://nop
                                 new byte[] { 0xA3,0xA0,0x0C,0x4B,0x00 });//mov [004B0CA0],eax
        }
        public override void setLockPlayer(bool b) {
            write(0x004381E7,b ? new byte[] { 0x90,0x90,0x90,0x90,0x90,0x90 } ://nop
                                 new byte[] { 0x29,0x1D,0x98,0x0C,0x4B,0x00 });//sub [004B0C98],ebx
        }
        public override void setUnbeatable(bool b) {
            write(0x00438379,b ? new byte[] { 0x90,0x90,0x90,0x90,0x90,0x90,0x90,0x90,0x90,0x90 } ://nop
                                 new byte[] { 0xC7,0x86,0x28,0x0A,0x00,0x00,0x04,0x00,0x00,0x00 });//mov [esi+00000A28],00000004
        }
