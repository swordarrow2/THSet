...
namespace THSet {
    class TH10Code:THCode {
        ...
        public override void setLockPlayer(bool b) {
            write(0x00426A1C,b ? new byte[] { 0x90,0x90,0x90,0x90,0x90,0x90 } ://nop
                                 new byte[] { 0x89,0x0D,0x70,0x4C,0x47,0x00 });//mov [00474C70],ecx
        }
        public override void setLockBomb(bool b) {
            write(0x004259D4,b ? new byte[] { 0x90,0x90,0x90,0x90,0x90,0x90,0x90,0x90 } ://nop
                                 new byte[] { 0x66,0x83,0x05,0x48,0x4C,0x47,0x00,0xEC });//add word ptr [00474C48],-14
            write(0x00425C43,b ? new byte[] { 0x90,0x90,0x90,0x90,0x90,0x90,0x90,0x90 } ://nop
                                 new byte[] { 0x66,0x83,0x05,0x48,0x4C,0x47,0x00,0xEC });//add word ptr [00474C48],-14
        }
