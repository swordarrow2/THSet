...
namespace THSet {
    class TH165Code:THCode {
        ...
        public override void setLockBomb(bool b) {
            ...
            write(0x0044A1DE,b ? new byte[] { 0x90,0x90,0x90,0x90,0x90,0x90,0x90 } : new byte[] { 0xC7,0x47,0x7C,0x00,0x00,0x00,0x00 });//mov [edi+7C],00000000
            write(0x00447F88,b ? new byte[] { 0x90,0x90,0x90,0x90,0x90 } : new byte[] { 0xF3,0x0F,0x11,0x47,0x7C });                    //movss [edi+7C],xmm0
        }

        public override void setUnbeatable(bool b) => write(0x00446A7A,b ? new byte[] { 0x90,0x90,0x90,0x90,0x90,0x90,0x90,0x90,0x90,0x90 } : new byte[] { 0xC7,0x87,0xA4,0x65,0x01,0x00,0x04,0x00,0x00,0x00 });//mov [edi+000165A4],00000004
