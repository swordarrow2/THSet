...
namespace THSet {
    class TH11Code:THCode {
        ...
        public override int getBulletCount() {
            return mt.ReadInteger(mt.ReadInteger(0x004A8D68)+0x5C);
        }
        public override int getBossLife() {
            return mt.ReadInteger(mt.ReadInteger(0x004A8D84)+0x43F8);
        }
        public override bool[] getEnable() {
            return new bool[] { true,true,true,true,true,false,false,true,false,
