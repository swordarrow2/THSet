...
namespace THSet {
    class TH15Code:THCode {
        ...
        public override void setMemoryTool(MemoryTool m) {
            mt=m;
            write(0x00456398,new byte[] { 0xE9,0x95,0x03,0x00,0x00 });
            write(0x00456732,new byte[] { 0xA3,0x50,0x74,0x4E,0x00,0xFF,0x05,0x3C,0x75,0x4E,0x00,0xEB,0x65 });
            write(0x004567A4,new byte[] { 0xE9,0xF4,0xFB,0xFF,0xFF });
            write(0x004E753C,0);



            write(0x0041497A,new byte[] { 0xE9,0x56,0xFF,0xFF,0xFF,0x90 });
            write(0x004148D5,new byte[] { 0xA3,0x5C,0x74,0x4E,0x00,0xEB,0x09 });
            write(0x004148E5,new byte[] { 0xFF,0x05,0x40,0x75,0x4E,0x00,0xE9,0x8F,0x00,0x00,0x00 });
            write(0x004E7540,0);
