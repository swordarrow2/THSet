...
namespace THSet {
    public class TH15Code:THCode {
        ...
        public override void setBossNum(ComboBox boss) {
            ...
            byte[] bossEcl = isExtra ? g4EclCode.TH15.eclTH15ExtraMainBossNum : g4EclCode.eclMainBossNum;
            int index = 0;
        ...
        public override void setComboBox(ComboBox stageBox,ComboBox chapterBox,ComboBox bossBox) {
            ...
            switch(stageBox.Text) {
                case "Stage1": bossBox.Items.AddRange(g4EclCode.TH15.stage1BossList); break;
                ...
                case "Stage5": bossBox.Items.AddRange(g4EclCode.TH15.stage5BossList); break;
