...
namespace THSet {
    class TH15Code:THCode {
        ...
        public override int getBulletCount() {
            return mt.ReadInteger(mt.ReadInteger(0x004E9A6C)+0x40);
        }
        public override int getBossLife() {
            return mt.ReadInteger(mt.ReadInteger(0x004E9A8C)+0x1D4);
        }
        ...
        public override void setUnbeatable(bool b) {
            write(0x0045669F,b ? new byte[] { 0x90,0x90,0x90,0x90,0x90,0x90,0x90,0x90,0x90,0x90 } ://nop
                                 new byte[] { 0xC7,0x87,0x20,0x62,0x01,0x00,0x04,0x00,0x00,0x00 });//mov [edi+00016220],00000004
        }
